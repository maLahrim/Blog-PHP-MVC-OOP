    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center w-responsive pt-3 m-auto homepage-inner-section-3 ">
            ...
            <a class="px-2" title="" target="_blank" href="#"> 
                <img src="/blog/img/partner/partner-01.png" alt=""> 
            </a>
            <a class="px-2" title="" target="_blank" href="#"> 
                <img src="/blog/img/partner/partner-02.png" alt=""> 
            </a>
            <a class="px-2" title="" target="_blank" href="#"> 
                <img src="/blog/img/partner/partner-03.png" alt=""> 
            </a>
            <a class="px-2" title="" target="_blank" href="#"> 
                <img src="/blog/img/partner/partner-04.png" alt=""> 
            </a>
        </div>
                ...
                <div class="col-12 col-lg-4 p-0 my-3">
                    <div class="card text-center">
                        <div class="card-body p-0">
                            <img class="author-img" src="/blog/img/single-image-11.jpg" alt="single-image-11" title="single-image-11">
                        </div>
                    </div>
                </div> 
                <div class="col-12 col-lg-4 ">
                    <div class="card">
                        <div class="card-body signature ">
                            ...
                            <p class="text-center mb-0"><img class="" src="/blog/img/single-image-12-300x203.png" alt="" width="106" height="72"></p>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="chapitres" class="container-fluid homepage-secondSection px-0">
    ...
    <div class="row col-12 m-auto article-text-color align-items-start">
        <div class="col-lg-3  p-0 pb-3 pt-lg-3 pb-lg-0 pr-lg-5">
            <img src="/blog/img/Billet-Simple-Pour-Alaska.png" alt="book">
        </div>
